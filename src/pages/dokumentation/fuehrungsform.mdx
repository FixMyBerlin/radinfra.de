...
| `bicycleRoad_vehicleDestination` | Fahrradstraße mit Anlieger frei order ["Kfz frei"](https://commons.wikimedia.org/wiki/File:Zusatzzeichen_KFZ_frei.svg) |  |  |
...
| `cyclewayOnHighwayProtected` | Geschützter Radfahrstreifen (Protected Bike Lane / PBL) | Erfordert detailliertes Tagging mit dem [`separation`-Schema](https://wiki.openstreetmap.org/wiki/Proposal:Separation). |  |
