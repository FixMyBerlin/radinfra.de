    ...
    legends: [
      {
        ...
        filterConfig: { key: 'data_incompleteness', values: [0.0] },
      },
      {
        key: 'm10',
        color: '#dfdfdf',
        label: 'Wenige Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [10.0] },
      },
      {
        key: 'm20',
        color: '#c4c4c4',
        label: 'Wenige Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [20.0] },
      },
      {
        key: 'm30',
        color: '#a8a8a8',
        label: 'Einige Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [30.0] },
      },
      {
        key: 'm40',
        color: '#8d8d8d',
        label: 'Einige Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [40.0] },
      },
      {
        key: 'm50',
        color: '#727272',
        label: 'Viele Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [50.0] },
      },
      {
        key: 'm60',
        color: '#575757',
        label: 'Viele Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [60.0] },
      },
      {
        key: 'm70',
        color: '#3b3b3b',
        label: 'Sehr viele Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [70.0] },
      },
      {
        key: 'm80',
        color: '#202020',
        label: 'Sehr viele Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [80.0] },
      },
      {
        key: 'm90',
        color: '#000000',
        label: 'Fast alle Daten fehlen',
        filterConfig: { key: 'data_incompleteness', values: [90.0] },
      },
    ],
  },
]
