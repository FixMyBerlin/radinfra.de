            ...
            {curentLegendGroup.map((legendGroup) => {
              return (
                <div key={`${params.anzeige}-${legendGroup.title}`}>
                  ...
                  <ul
                    className={twJoin(
                      'group/legend px-2 pb-4 text-sm leading-4 font-normal text-gray-900',
                    )}
                  >
                      ...
                      return (
                        ...
                        >
                          ...
                          {filteringEnabled && (
                            <button
                              className={twJoin(
                                'rounded-md border border-white p-1.5 transition-colors group-hover/focus:border-gray-200 group-hover/focus:bg-cyan-50 group-hover/legend:text-gray-800 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white/75',
